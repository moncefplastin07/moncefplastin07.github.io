  ...
  <Layout title="Moncef Gaha">
    ...
    <div className="text-center">
      ...
      <p className="text-gray-800 p-5">
        ...
        <span>{" "}.{" "}</span>
        <span>
          <a href="https://twitter.com/moncefplastin07/" className='hover:text-gray-100'>Twitter</a>
        </span>
        <span>{" "}.{" "}</span>
        <span>
          <a href="https://facebook.com/moncefplastin07/" className='hover:text-gray-100'>Facebook</a>
        </span>
        <span>{" "}.{" "}</span>
        <span>
          <a href="https://instagram.com/moncefplastin07/" className='hover:text-gray-100'>Instagram</a>
        </span>
      </p>

      <p className='text-xl p-4'>Web backend Developer from Biskra/Algeria</p>
      <p className="text-md p-5">Email: <a href='mailto:x@moncefgaha.me'>x@moncefgaha.me</a></p>
