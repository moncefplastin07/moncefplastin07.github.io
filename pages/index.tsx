  ...
  <Layout title="Moncef Gaha">
    ...
    <div className="text-center">
      ...
      <p className="text-gray-800 p-5">
        <span>
          <a href="https://github.com/moncefplastin07" className='hover:text-gray-600'>
            Github
          </a>
        </span>
        <span>{" "}.{" "}</span>
        <span>
          <a href="https://twitter.com/moncefplastin07/" className='hover:text-gray-600'>Twitter</a>
        </span>
        <span>{" "}.{" "}</span>
        <span>
          <a href="https://facebook.com/moncefplastin07/" className='hover:text-gray-600'>Facebook</a>
        </span>
        <span>{" "}.{" "}</span>
        <span>
          <a href="https://instagram.com/moncefplastin07/" className='hover:text-gray-600'>Instagram</a>
        </span>
      </p>

      <p className='text-xl p-4'>Web backend Developer from Biskra/Algeria</p>
      <p className="text-md p-5">Email: <a href='mailto:x@moncefgaha.me' className='font-bold p-2 rounded-md border border-green-300 bg-green-300 bg-opacity-20'>x@moncefgaha.me</a></p>
